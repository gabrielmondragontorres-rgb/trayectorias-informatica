...
## Mascota Lobo Gris — Colegio de Bachilleres México

Para las guías oficiales del Colegio de Bachilleres (COBACH), **NUNCA** se debe incluir al personaje Levy de la SaaS-Factory ni su nombre ("Levi" o "Levy"), ni firmas artísticas o marcas comerciales en las imágenes. En su lugar, cuando se requiera un personaje amigable o una mascota para ilustrar, se debe utilizar el **Lobo Gris** (la mascota oficial de la institución, apodado "Lobacho").

### Cómo Incluir al Lobo Gris

1. En el prompt: `"un lobo gris de caricatura (doodle), mascota del Colegio de Bachilleres México, con pelaje gris y expresión amigable y entusiasta. Viste una playera deportiva blanca con el logo institucional del Colegio de Bachilleres en el pecho (el logotipo verde de líneas curvas estilizadas)."`
2. Describir la POSE o ACCIÓN específica al contexto del tema (por ejemplo, sosteniendo un lápiz gigante, señalando un pizarrón o revisando una pantalla).

### Cuando Incluir vs Excluir a la Mascota

| Incluir al Lobo Gris (SÍ) | Excluir a la Mascota (NO) |
|---------------------------|---------------------------|
| Presentando un concepto central | Diagramas de flujo puros |
| Comparaciones ANTES/DESPUÉS | Listas de características/acciones simples |
| Recomendando una opción o buenas prácticas | Conceptos técnicos abstractos y fórmulas |
| Introducciones de Corte o actividades integradoras | Tablas de datos numéricos |

### Reglas de Posicionamiento y Texto
- La mascota va a la IZQUIERDA cuando señala contenido a la DERECHA.
- La mascota va a la DERECHA cuando mira/señala contenido a la IZQUIERDA.
- **Evitar nombres en el lienzo:** Bajo ninguna circunstancia se debe incluir texto de firmas, nombres como "Levi", "Levy" o "Lobacho" en las imágenes. Todo el texto visible en la infografía debe limitarse a las etiquetas en español explicativas en Sentence Case.
